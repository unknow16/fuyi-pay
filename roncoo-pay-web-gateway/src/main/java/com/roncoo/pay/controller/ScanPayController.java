...
public class ScanPayController extends BaseController {
    ...
    public String initPay(Model model , HttpServletRequest httpServletRequest){
        ...
        if (StringUtil.isEmpty(payWayCode)){//非直连方式
            ...
            //包含的codeUrl表单数据
            ScanPayResultVo scanPayResultVo = rpTradePaymentManagerService.initDirectScanPay(
            		payKey, productName, orderNo, orderDate, orderTime, orderPrice, payWayCode, orderIp, orderPeriod, 
