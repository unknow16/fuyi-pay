...
public class AlipayConfigUtil {
	...
	/*******new alipay config  非对称加蜜************/
	public static final String open_api_domain = (String) properties.get("open_api_domain");
	public static final String appid = (String) properties.get("appid");
	public static final String pid = (String) properties.get("pid");
	public static final String private_key = (String) properties.get("private_key"); //自己私钥
	public static final String public_key = (String) properties.get("public_key"); //自己公钥
	public static final String alipay_public_key = (String) properties.get("alipay_public_key"); //支付宝公钥
